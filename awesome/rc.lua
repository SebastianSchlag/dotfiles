...
function random_wallpaper()
    wp_path = os.getenv("HOME") .. "/wallpaper/"
...
for s = 1, screen.count() do
    ...
    -- Widgets that are aligned to the right foobar
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey },            "e",     function () awful.util.spawn("emacsclient -nc --alternate-editor emacs ~/Dropbox/org/startup.org") end),
